...
const StyledMainContainer=(0,styled_components__WEBPACK_IMPORTED_MODULE_4__["default"])(_styles__WEBPACK_IMPORTED_MODULE_2__/* .Main */ .or).withConfig({displayName:"pages__StyledMainContainer",componentId:"sc-z98rio-0"})(["counter-reset:section;"]);const IndexContent=({data})=>{const{language}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_styles_LanguageContext__WEBPACK_IMPORTED_MODULE_3__/* .LanguageContext */ .AZ);console.log("Language in IndexContent:",language);console.log("data",data);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ .Ar,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,{className:"fillHeight"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Hero */ .VM,{data:data.hero.edges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .About */ .CL,{data:data.about.edges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Jobs */ .pe,{data:data.jobs.edges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Featured */ .g4,{data:data.featured.edges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Projects */ .pj,{data:data.projects.edges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Contact */ .r8,{data:data.contact.edges})));};const IndexPage=({location,data})=>{console.log("data in page",data);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_LanguageContext__WEBPACK_IMPORTED_MODULE_3__/* .LanguageProvider */ .iL,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IndexContent,{location:location,data:data}));};IndexPage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired,data:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage);const pageQuery="4010407604";
