...
/* harmony import */ var _styles_LanguageContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4399);
const StyledMainContainer=(0,styled_components__WEBPACK_IMPORTED_MODULE_4__["default"])(_styles__WEBPACK_IMPORTED_MODULE_2__/* .Main */ .or).withConfig({displayName:"pages__StyledMainContainer",componentId:"sc-z98rio-0"})(["counter-reset:section;"]);const IndexPage=({location,data})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_LanguageContext__WEBPACK_IMPORTED_MODULE_3__/* .LanguageProvider */ .iL,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(IndexContent,{location:location,data:data}));};const IndexContent=({location,data})=>{const{language}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_styles_LanguageContext__WEBPACK_IMPORTED_MODULE_3__/* .LanguageContext */ .AZ);const filteredHeroEdges=data.hero.edges.filter(edge=>edge.node.frontmatter.lang===language);const filteredAboutEdges=data.about.edges.filter(edge=>edge.node.frontmatter.lang===language);const filteredJobsEdges=data.jobs.edges.filter(edge=>edge.node.frontmatter.lang===language);const filteredFeaturedEdges=data.featured.edges.filter(edge=>edge.node.frontmatter.lang===language);const filteredProjectsEdges=data.projects.edges.filter(edge=>edge.node.frontmatter.lang===language);const filteredContactEdges=data.contact.edges.filter(edge=>edge.node.frontmatter.lang===language);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Layout */ .Ar,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,{className:"fillHeight"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Hero */ .VM,{data:filteredHeroEdges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .About */ .CL,{data:filteredAboutEdges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Jobs */ .pe,{data:filteredJobsEdges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Featured */ .g4,{data:filteredFeaturedEdges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Projects */ .pj,{data:filteredProjectsEdges}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_1__/* .Contact */ .r8,{data:filteredContactEdges})));};IndexContent.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired,data:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired};IndexPage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired,data:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage);const pageQuery="3426803019";
