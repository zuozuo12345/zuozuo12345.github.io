...
const{colors: featured_colors,fontSizes: featured_fontSizes,fonts: featured_fonts}=styles.theme;const featured_StyledContainer=(0,styled_components_esm["default"])(styles/* Section */.$0).withConfig({displayName:"featured__StyledContainer",componentId:"sc-19vdtah-0"})(["",";flex-direction:column;align-items:flex-start;"],styles/* mixins */.tA.flexCenter);const featured_StyledContent=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledContent",componentId:"sc-19vdtah-1"})(["position:relative;grid-column:1 / 7;grid-row:1 / -1;",";",";"],styles/* media */.BC.thone`
  ...
  `,styles/* mixins */.tA.inlineLink);const StyledTechList=styled_components_esm["default"].ul.withConfig({displayName:"featured__StyledTechList",componentId:"sc-19vdtah-5"})(["position:relative;z-index:2;display:flex;flex-wrap:wrap;padding:0;margin:25px 0 10px;list-style:none;li{font-family:",";font-size:",";color:",";margin-right:",";margin-bottom:7px;white-space:nowrap;&:last-of-type{margin-right:0;}",";}"],featured_fonts.SFMono,featured_fontSizes.smish,featured_colors.green,styles.theme.margin,styles/* media */.BC.thone`
      ...
      margin-right: 10px;
    `);const featured_StyledLinkWrapper=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledLinkWrapper",componentId:"sc-19vdtah-6"})(["display:flex;align-items:center;position:relative;margin-top:10px;margin-left:-10px;color:",";a{padding:10px;svg{width:22px;height:22px;}}"],featured_colors.lightestSlate);const StyledFeaturedImg=(0,styled_components_esm["default"])(gatsby_image/* default */.Z).withConfig({displayName:"featured__StyledFeaturedImg",componentId:"sc-19vdtah-7"})(["width:100%;max-width:100%;vertical-align:middle;border-radius:",";position:relative;mix-blend-mode:multiply;filter:grayscale(100%) contrast(1) brightness(90%);",";"],styles.theme.borderRadius,styles/* media */.BC.tablet`
    object-fit: cover;
    width: auto;
    height: 100%;
    filter: grayscale(100%) contrast(1) brightness(80%);
  `);const StyledImgContainer=styled_components_esm["default"].a.withConfig({displayName:"featured__StyledImgContainer",componentId:"sc-19vdtah-8"})(["",";grid-column:6 / -1;grid-row:1 / -1;position:relative;z-index:1;background-color:",";border-radius:","px;transition:",";",";",";&:hover,&:focus{background:transparent;&:before,","{background:transparent;filter:none;}}&:before{content:'';position:absolute;width:100%;height:100%;top:0;left:0;right:0;bottom:0;z-index:3;transition:",";background-color:",";mix-blend-mode:screen;}"],styles/* mixins */.tA.boxShadow,featured_colors.green,styles.theme.radius+1,styles.theme.transition,styles/* media */.BC.tablet`height: 100%;`,styles/* media */.BC.thone`
    grid-column: 1 / -1;
    opacity: 0.25;
