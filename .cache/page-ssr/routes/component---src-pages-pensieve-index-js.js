...
// EXTERNAL MODULE: external "/Users/zuoyue/Documents/GitHub/zuozuo12345.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(5285);
...
/* harmony default export */ const og = ("/static/og-76637778a777c6dc6370f434a0997118.png");
...
const{colors: featured_colors,fontSizes: featured_fontSizes,fonts: featured_fonts}=styles.theme;const featured_StyledContainer=(0,styled_components_esm["default"])(styles/* Section */.$0).withConfig({displayName:"featured__StyledContainer",componentId:"sc-19vdtah-0"})(["",";flex-direction:column;align-items:flex-start;"],styles/* mixins */.tA.flexCenter);const featured_StyledContent=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledContent",componentId:"sc-19vdtah-1"})(["position:relative;grid-column:1 / 7;grid-row:1 / -1;",";",";"],styles/* media */.BC.thone`
  ...
  `,styles/* mixins */.tA.inlineLink);const StyledTechList=styled_components_esm["default"].ul.withConfig({displayName:"featured__StyledTechList",componentId:"sc-19vdtah-5"})(["position:relative;z-index:2;display:flex;flex-wrap:wrap;padding:0;margin:25px 0 10px;list-style:none;li{font-family:",";font-size:",";color:",";margin-right:",";margin-bottom:7px;white-space:nowrap;&:last-of-type{margin-right:0;}",";}"],featured_fonts.SFMono,featured_fontSizes.smish,featured_colors.green,styles.theme.margin,styles/* media */.BC.thone`
      ...
      margin-right: 10px;
    `);const featured_StyledLinkWrapper=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledLinkWrapper",componentId:"sc-19vdtah-6"})(["display:flex;align-items:center;position:relative;margin-top:10px;margin-left:-10px;color:",";a{padding:10px;svg{width:22px;height:22px;}}"],featured_colors.lightestSlate);const StyledFeaturedImg=(0,styled_components_esm["default"])(gatsby_image/* default */.Z).withConfig({displayName:"featured__StyledFeaturedImg",componentId:"sc-19vdtah-7"})(["width:100%;max-width:100%;vertical-align:middle;border-radius:",";position:relative;mix-blend-mode:multiply;",";"],styles.theme.borderRadius,styles/* media */.BC.tablet`
    object-fit: cover;
    width: auto;
    height: 100%;
    filter: grayscale(100%) contrast(1) brightness(80%);
  `);const StyledImgContainer=styled_components_esm["default"].a.withConfig({displayName:"featured__StyledImgContainer",componentId:"sc-19vdtah-8"})(["",";grid-column:6 / -1;grid-row:1 / -1;position:relative;z-index:1;background-color:transparent;border-radius:","px;transition:",";",";",";&:hover,&:focus{background:transparent;&:before,","{background:transparent;filter:none;}}&:before{content:'';position:absolute;width:100%;height:100%;top:0;left:0;right:0;bottom:0;z-index:3;transition:",";background-color:",";mix-blend-mode:screen;}"],styles/* mixins */.tA.boxShadow,styles.theme.radius+1,styles.theme.transition,styles/* media */.BC.tablet`height: 100%;`,styles/* media */.BC.thone`
    grid-column: 1 / -1;
    opacity: 0.25;
  `,StyledFeaturedImg,styles.theme.transition,featured_colors.navy);const StyledProject=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledProject",componentId:"sc-19vdtah-9"})(["display:grid;grid-gap:10px;grid-template-columns:repeat(12,1fr);align-items:center;margin-bottom:100px;",";&:last-of-type{margin-bottom:0;}&:nth-of-type(odd){","{grid-column:7 / -1;text-align:right;",";",";}","{justify-content:flex-end;li{margin-left:",";margin-right:0;}}","{justify-content:flex-end;margin-left:0;margin-right:-10px;}","{grid-column:1 / 8;",";",";}}"],styles/* media */.BC.thone`
    margin-bottom: 70px;
...
module.exports={siteTitle:'Zuo Yue | Software Developer',siteDescription:'Zuo Yue is a Software Developer at Amdocs, who loves learning new things and helping tech beginners.',siteKeywords:'Zuo Yue, Zuo, Yue, zuozuo12345, software developer, software engineer, content freelancer, face mask, face mask detection, web developer, java developer, pepper content, jamshedpur, amdocs, bit, mesra',siteUrl:'https://zuozuo12345.github.io/',siteLanguage:'en_US',name:'Zuo Yue',location:'Singapore, Singapore',email:'yue.zuo@u.nus.edu',github:'https://github.com/zuozuo12345',twitterHandle:'@zuozuo12345',socialMedia:[{name:'GitHub',url:'https://github.com/zuozuo12345'},{name:'Linkedin',url:'https://www.linkedin.com/in/yue-zuo-97a72021a'}// {
//   name: 'Codepen',
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(9550);
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1428);
/* harmony import */ var _styles_LanguageContext__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4399);
const{colors,fontSizes,fonts}=_styles__WEBPACK_IMPORTED_MODULE_6__.theme;const StyledMainContainer=(0,styled_components__WEBPACK_IMPORTED_MODULE_8__["default"])(_styles__WEBPACK_IMPORTED_MODULE_6__/* .Main */ .or).withConfig({displayName:"pensieve__StyledMainContainer",componentId:"sc-9gzs8o-0"})(["& > header{text-align:center;margin-bottom:100px;a{&:hover,&:focus{cursor:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='40' height='48' viewport='0 0 100 100' style='fill:black;font-size:24px;'><text y='50%'>\u26A1</text></svg>\") 20 0,auto;}}}footer{",";margin-top:20px;width:100%;}"],_styles__WEBPACK_IMPORTED_MODULE_6__/* .mixins */ .tA.flexBetween);const StyledGrid=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({displayName:"pensieve__StyledGrid",componentId:"sc-9gzs8o-1"})(["margin-top:50px;.posts{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));grid-gap:15px;position:relative;",";}"],_styles__WEBPACK_IMPORTED_MODULE_6__/* .media */ .BC.desktop`grid-template-columns: repeat(auto-fill, minmax(250px, 1fr));`);const StyledPostInner=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({displayName:"pensieve__StyledPostInner",componentId:"sc-9gzs8o-2"})(["",";",";flex-direction:column;align-items:flex-start;position:relative;padding:2rem 1.75rem;height:100%;border-radius:",";transition:",";background-color:",";header,a{width:100%;}"],_styles__WEBPACK_IMPORTED_MODULE_6__/* .mixins */ .tA.boxShadow,_styles__WEBPACK_IMPORTED_MODULE_6__/* .mixins */ .tA.flexBetween,_styles__WEBPACK_IMPORTED_MODULE_6__.theme.borderRadius,_styles__WEBPACK_IMPORTED_MODULE_6__.theme.transition,colors.lightNavy);const StyledPost=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({displayName:"pensieve__StyledPost",componentId:"sc-9gzs8o-3"})(["transition:",";cursor:default;&:hover,&:focus{outline:0;","{transform:translateY(-5px);}}"],_styles__WEBPACK_IMPORTED_MODULE_6__.theme.transition,StyledPostInner);const StyledPostHeader=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({displayName:"pensieve__StyledPostHeader",componentId:"sc-9gzs8o-4"})(["",";margin-bottom:30px;"],_styles__WEBPACK_IMPORTED_MODULE_6__/* .mixins */ .tA.flexBetween);const StyledFolder=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({displayName:"pensieve__StyledFolder",componentId:"sc-9gzs8o-5"})(["color:",";svg{width:40px;height:40px;}"],colors.green);const StyledPostName=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].h5.withConfig({displayName:"pensieve__StyledPostName",componentId:"sc-9gzs8o-6"})(["margin:0 0 10px;font-size:",";color:",";"],fontSizes.xxl,colors.lightestSlate);const StyledPostDescription=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].div.withConfig({displayName:"pensieve__StyledPostDescription",componentId:"sc-9gzs8o-7"})(["font-size:17px;color:",";"],colors.lightSlate);const StyledDate=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].span.withConfig({displayName:"pensieve__StyledDate",componentId:"sc-9gzs8o-8"})(["text-transform:uppercase;font-family:",";font-size:",";color:",";"],fonts.SFMono,fontSizes.xs,colors.lightSlate);const StyledTags=styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].ul.withConfig({displayName:"pensieve__StyledTags",componentId:"sc-9gzs8o-9"})(["display:flex;align-items:flex-end;flex-wrap:wrap;padding:0;margin:0;list-style:none;li{font-family:",";font-size:",";color:",";line-height:1.75;margin-right:15px;&:last-of-type{margin-right:0;}a{",";}}"],fonts.SFMono,fontSizes.xs,colors.green,_styles__WEBPACK_IMPORTED_MODULE_6__/* .mixins */ .tA.inlineLink);const PensievePage=({location,data})=>{const posts=data.allMarkdownRemark.edges;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_styles_LanguageContext__WEBPACK_IMPORTED_MODULE_7__/* .LanguageProvider */ .iL,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_4__/* .Layout */ .Ar,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__.Helmet,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title",null,"Pensieve | Zuo Yue"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("link",{rel:"canonical",href:"https://zuozuo12345.github.io/pensieve"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"big-title"},"Pensieve"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"subtitle"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:"https://www.wizardingworld.com/writing-by-jk-rowling/pensieve",target:"_blank",rel:"noopener noreferrer"},"a collection of memories"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledGrid,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"posts"},posts.length>0&&posts.map(({node},i)=>{const{frontmatter}=node;const{title,description,slug,date,tags}=frontmatter;const d=new Date(date);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledPost,{key:i,tabIndex:"0"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledPostInner,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:slug},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledPostHeader,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledFolder,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_5__/* .IconZap */ .BX,null))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledPostName,null,title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledPostDescription,null,description))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("footer",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledDate,null,`${d.toLocaleDateString()}`),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTags,null,tags.map((tag,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/pensieve/tags/${lodash_kebabCase__WEBPACK_IMPORTED_MODULE_3___default()(tag)}/`},"#",tag)))))));}))))));};PensievePage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_9___default().object).isRequired,data:(prop_types__WEBPACK_IMPORTED_MODULE_9___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PensievePage);const pageQuery="1490430893";
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5285);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
const LanguageContext=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)();const LanguageProvider=({children})=>{const{0:language,1:setLanguage}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('en');const switchLanguage=lang=>setLanguage(lang);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(LanguageContext.Provider,{value:{language,switchLanguage}},children);};const useLanguage=()=>{const context=useContext(LanguageContext);if(!context){throw new Error('aaaaaa');}return context;};
...
*/
var aa=__webpack_require__(5285),m=__webpack_require__(4852),r=__webpack_require__(3840);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
